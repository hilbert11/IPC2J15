<%@ Page Title="GestionEmpleados" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="GestionEmpleados.aspx.cs" Inherits="IPC2Fase2QE.GestionEmpleados" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td class="modal-sm" style="width: 302px">
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataKeyNames="Cod_Empleado" DataSourceID="SqlDataSource2" ForeColor="Black" GridLines="None">
